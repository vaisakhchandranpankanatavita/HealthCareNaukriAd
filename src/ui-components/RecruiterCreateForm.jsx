...
export default function RecruiterCreateForm(props) {
  ...
  const resetStateValues = () => {
    setHospital_name(initialValues.hospital_name);
    setContact_name(initialValues.contact_name);
    setEmail(initialValues.email);
    setLand_line(initialValues.land_line);
    ...
    setRecruiter_details(initialValues.recruiter_details);
    setApproved(initialValues.approved);
    setIs_super_admin(initialValues.is_super_admin);
    setErrors({});
  };
  const validations = {
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Recruiter(modelFields));
          if (onSuccess) {
