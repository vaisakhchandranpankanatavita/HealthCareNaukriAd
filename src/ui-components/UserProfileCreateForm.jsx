...
export default function UserProfileCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setNursing_council(initialValues.nursing_council);
    setAdditional_qualification(initialValues.additional_qualification);
    setResume(initialValues.resume);
    setPhoto(initialValues.photo);
    setApplied_jobs(initialValues.applied_jobs);
